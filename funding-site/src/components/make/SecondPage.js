...
const SecondPage = ({ settingPage2, data}) => {
    ...
    const save = e =>{ 
        r1.current.className = 'click_div';r5.current.className = 'click_div';
        r2.current.className = 'display_none';r6.current.className = 'display_none';
        r3.current.className = 'click_div';r7.current.className = 'click_div';
        r4.current.className = 'display_none';r8.current.className = 'display_none';settingPage2({target, start, end, present, hwanbul}); }
    ...
    const r7 = useRef();const r8 = useRef();

    const onClick1 = e =>{
        r1.current.className = 'display_none';r6.current.className = 'display_none';
        r2.current.className = 'content_div99';r7.current.className = 'click_div';
    ...
    const onClick2 = e =>{
        ...
        r3.current.className = 'display_none';r8.current.className = 'display_none';
        r4.current.className = 'content_div99';
        r5.current.className = 'click_div';
    }
    const onClick3 = e =>{
        r1.current.className = 'click_div';r6.current.className = 'content_div99';
        r2.current.className = 'display_none';r7.current.className = 'click_div';
        r3.current.className = 'click_div';r8.current.className = 'display_none';
        r4.current.className = 'display_none';
    ...
    const onClick4 = e =>{
        r1.current.className = 'click_div';r6.current.className = 'display_none';
        r2.current.className = 'display_none';r7.current.className = 'display_none';
        r3.current.className = 'click_div';r8.current.className = 'content_div99';
        r4.current.className = 'display_none';
        r5.current.className = 'click_div';
    }
    ...
    return(
        <div className="second_zone">
                ...
                <div className="display_none" ref={r2}>
                    ...
                    <div>이번 프로젝트를 통해 모으고자 하는 펀딩 목표 금액이 얼마인가요?<br/>
                        ...
                        <div className="susu_div">
                            ...
                            <div className="maringbottom22">위 금액을 모으는 데 성공하실 경우, <span className="text_bold">대략 {Math.floor((target - (target * 0.033 + target * 0.055))).toLocaleString()} 원 정도</span>를 받게 됩니다. 총 모금액에서 대략적으로 아래와 같은 금액이 공제됩니다.</div>
                            <div className="susu_div_left">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>{Math.floor(target * 0.033).toLocaleString()}원</td>
                                    </tr>
                                    <tr>
                                        <td>플랫폼 수수료(5% + VAT)</td>
                                        <td>{Math.floor(target * 0.055).toLocaleString()}원</td>
                                    </tr>
                                    <tr className="text_bold">
                                        <td>공제액 합계</td>
                                        <td>{Math.floor(target * 0.033 + target * 0.055).toLocaleString()}원</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
            ...
            <div className="input_area99">
                ...
                <div   className="click_div" ref={r5} onClick={onClick3}>
                ...
                <div className="display_none" ref={r6}>
                    <div className="input_title">프로젝트 마감일</div>
            ...
            <div className="input_area99">
                <div   className="click_div" ref={r7} onClick={onClick4}>
                ...
                <div className="display_none" ref={r8}>
                    <div className="input_title">환불 및 교환 정책</div>
